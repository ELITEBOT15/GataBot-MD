...
await conn.reply(NumeroUser + '@s.whatsapp.net', `✨ *¡Hola! @${NumeroUser}, @${user} ¡¡Polvora Bot te ha invitado!!*`, null, {mentions: [NumeroUser + '@s.whatsapp.net', m.sender]})    
